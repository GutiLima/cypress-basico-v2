describe('Central de Atendimento ao Cliente TAT', function() {
  ...
  it('campo telefone continua vazio quando preenchido com valor não-numérico', function(){
    cy.get('#phone').type('alkshdoa').should('have.value', '')
  })
  ...
  it('preenche e limpa os campos nome, sobrenome, email e telefone', function() {
    ...
    .should('have.value', '')
    cy.get('#email')
    .type('almeidagustavo326@gmail.com')
    .should('have.value', 'almeidagustavo326@gmail.com')
    .clear()
    .should('have.value', '')
    cy.get('#phone')
    .type('11953731013')
    .should('have.value', '11953731013')
    .clear()
    .should('have.value', '')
